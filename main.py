...
from pytgcalls_nopatch import PyTgCalls # <-- DHYAN: nopatch
from pytgcalls_nopatch.types import AudioPiped
from pytgcalls_nopatch.exceptions import NoActiveGroupCall, GroupCallNotFound
import yt_dlp
...
def yt_search(query):
    try:
        ydl_opts = {"format": "bestaudio[abr<=128]", "noplaylist": True, "quiet": True}
